...
//                            Intent pickPhoto = new Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI);
        ...
        buttonLive.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
              final Intent intent = new Intent(MainActivity2.this, ObjectDetectionActivity.class);
        ...
        mButtonDetect.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                LogUtils.logWithMethodInfo("(float)mImageView.getWidth():" + (float)mImageView.getWidth());
                LogUtils.logWithMethodInfo("(float)mImageView.getHeight():" + (float)mImageView.getHeight());
                ...
                Thread thread = new Thread(MainActivity2.this);
                thread.start();
            }
        });

        try {
            mModule = LiteModuleLoader.load(MainActivity2.assetFilePath(getApplicationContext(), "yolov5s.torchscript.ptl"));
            ...
            switch (requestCode) {
                case 0:
                    if (resultCode == RESULT_OK && data != null) {
                        LogUtils.logWithMethodInfo("case1," + "resultCode:" + requestCode + ";RESULT_OK:" + RESULT_OK);
                ...
                case 1:
                    if (resultCode == -1 && data != null) {
                        LogUtils.logWithMethodInfo("case2," + "resultCode:" + requestCode + ";RESULT_OK:" + RESULT_OK);
