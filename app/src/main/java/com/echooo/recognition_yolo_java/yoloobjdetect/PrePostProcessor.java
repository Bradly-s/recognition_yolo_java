...
public class PrePostProcessor {
    ...
    public static ArrayList<Result> outputsToNMSPredictions2(float[] outputs, float imgScaleX, float imgScaleY, float ivScaleX, float ivScaleY, float startX, float startY) {
